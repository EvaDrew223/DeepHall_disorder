...
class DisorderConfig:
    """Configuration for random charge disorder on a donor shell."""

    n_dis: int = 0
    "Number of impurity charges on the donor shell."

    disorder_separation: float = 0.5
    "Separation d between electron sphere (radius R) and donor shell (radius R_d = R + d)."

    max_disorder_charge: float = 1.0
    "Maximum magnitude of disorder charges (in units of electron charge e)."

    disorder_strength: float = 1.0
    "Overall strength factor for the disorder potential."

    disorder_seed: int | None = None
    "Random seed for generating disorder configuration. If None, uses system seed."
...
class System:
    ...
    "Configuration for random charge disorder."
