...
class ImpurityConfiguration(NamedTuple):
    """Configuration for disorder impurities on the donor shell."""

    n_dis: int
    "Number of impurities."

    positions: jnp.ndarray
    "Cartesian coordinates of impurities on unit sphere, shape (n_dis, 3)."

    charges: jnp.ndarray
    "Charges of impurities in units of e, shape (n_dis,). Sum should be ~0."

    donor_radius: float
    "Radius of the donor shell R_d = R + d."
...
class OtherObservables(AngularMomenta):
    ...
    disorder_potential: jnp.ndarray
